...
import java.awt.*;
import java.sql.*;
// Importaciones necesarias: JDBC para BD, Swing para GUI, AWT para layouts

// Clase principal para la gestión de usuarios (CRUD)
public class UsuarioForm extends JFrame {

    // ----------------- COMPONENTES DE LA INTERFAZ -----------------
    private JTextField txtId, txtNombre, txtEmail, txtUsuario, txtRol; // Campos de texto
    private JPasswordField txtContrasena;                              // Campo de contraseña
    ...
    public UsuarioForm() {
        ...
        setLayout(new BorderLayout(10, 10)); // Diseño principal con bordes
        ...
        // Etiquetas + campos en el formulario
        ...
        // Se añaden botones al panel inferior
        ...
        // Se agregan los paneles al frame principal
    ...
    private void agregarUsuario() {
        ...
        try (Connection con = ConexionBD.getConnection(); 
            ...
            // Se cargan los parámetros con los datos ingresados
    ...
    private void consultarUsuario() {
        ...
        try (Connection con = ConexionBD.getConnection(); 
            ...
            // Si encuentra el usuario, carga los datos en los campos
            if (rs.next()) {
    ...
    // ---------------- CLASE INTERNA DE CONEXIÓN (Placeholder) ----------------
    private static class ConexionBD {

        private static Connection getConnection() {
            // Método generado por defecto, aún no implementado
